...
import { getPendingEvents, updateStatusEvents } from "../../../redux/actions";
        ...
        <TableContainer>
          ...
          >
            <EnhancedTableHead
              ...
              rowCount={pendingEvents.length}
            />
            <TableBody>
              {stableSort(pendingEvents, getComparator(order, orderBy))
                    ...
                    <TableRow hover role="checkbox" tabIndex={-1} key={row._id}>
                      ...
                      <TableCell align="right">
                        <Button
                          ...
                          onClick={() =>
                            dispatch(updateStatusEvents(row._id, "ACCEPT"))
                          }
                        >
                          Approve
                        </Button>
                        <Button
                          ...
                          onClick={() =>
                            dispatch(updateStatusEvents(row._id, "REJECT"))
                          }
                        >
                          Reject
                        </Button>
